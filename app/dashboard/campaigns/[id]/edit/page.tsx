...
const mockCampaign = {
  ...
  description: 'Our Water Initiative campaign aims to bring clean water to 10,000 families in rural Kenya.',
  project: 'Water Initiative',
  startDate: '2024-01-01',
  endDate: '2024-03-31',
  status: 'active',
  objective: 'Raise $50,000 and reach 100,000 people',
  targetAudience: 'Christian communities, age 25-65, interested in humanitarian work',
  budget: '5000',
...
export default function EditCampaignPage() {
  ...
  useEffect(() => {
    ...
    const loadCampaign = async () => {
      ...
      reset(mockCampaign);
      setSelectedPlatforms(mockCampaign.platforms);
      setIsLoading(false);
    };
    loadCampaign();
  }, [campaignId, reset]);
  ...
  const onSubmit = async (data: CampaignFormData) => {
    ...
    console.log('Updating campaign:', { ...data, platforms: selectedPlatforms });
                  ...
                  <Grid item xs={12} sm={6}>
                    <FormControl fullWidth error={!!errors.project}>
                      ...
                      <Select
                        ...
                        defaultValue={mockCampaign.project}
            ...
            <Card sx={{ mb: 3 }}>
              <CardContent sx={{ p: 3 }}>
                ...
                <Typography variant="body2" color="text.secondary" sx={{ mb: 2 }}>
                  This campaign will be managed using CloudCampaign API for cross-platform
